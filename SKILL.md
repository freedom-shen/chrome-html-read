...
description: 当用户要求读取、总结或提取 Chrome 浏览器中已打开网页的内容、列出已打开的标签页、或在已打开的标签页中搜索时使用。适用于用户提到"看看我打开的网页""读一下我现在开的这个页面""我浏览器里那个 tab""读取浏览器内容""总结一下我当前看的网页""我开了哪些网页""在我打开的网页里搜一下",或希望把浏览器中的实时内容(含已登录页面)喂给对话的场景。
---
